        ...
        <form className="mx-auto mt-10 p-6">
            ...
            <div className="flex items-center mb-4">
                ...
                <label htmlFor="public"
                       className="ms-2 text-lg font-medium text-gray-900 dark:text-gray-400">Public</label>
            </div>
            ...
            <button type="submit"
                    className="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit
            </button>
        </form>
